...
</#if><#-- lib_wolfcrypt.CRYPTO_WC_SHA2_256 || CRYPTO_HW_SHA2_256 || CRYPTO_ICM11105_SHA2_256 -->
...
</#if><#-- lib_wolfcrypt.CRYPTO_WC_SHA2_384 || CRYPTO_HW_SHA2_384 -->
...
<#if (lib_wolfcrypt.CRYPTO_WC_SHAKE_128?? &&(lib_wolfcrypt.CRYPTO_WC_SHAKE_128 == true))>
    CRYPTO_HASH_SHA3_SHAKE128 = 12,
</#if><#-- lib_wolfcrypt.CRYPTO_WC_SHAKE_128 -->
<#if (lib_wolfcrypt.CRYPTO_WC_SHAKE_256?? &&(lib_wolfcrypt.CRYPTO_WC_SHAKE_256 == true))>
    CRYPTO_HASH_SHA3_SHAKE256 = 13,
</#if><#-- lib_wolfcrypt.CRYPTO_WC_SHAKE_256 -->
<#if (lib_wolfcrypt.CRYPTO_WC_BLAKE2B?? &&(lib_wolfcrypt.CRYPTO_WC_BLAKE2B == true))>
    CRYPTO_HASH_BLAKE2B = 14,
</#if><#-- lib_wolfcrypt.CRYPTO_WC_BLAKE2B -->
<#if (lib_wolfcrypt.CRYPTO_WC_BLAKE2S?? &&(lib_wolfcrypt.CRYPTO_WC_BLAKE2S == true)) >
...
<#if    (lib_wolfcrypt.CRYPTO_WC_SHA1?? &&(lib_wolfcrypt.CRYPTO_WC_SHA1 == true))
