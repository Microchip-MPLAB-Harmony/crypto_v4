...
<#if (HAVE_CRYPTO_HW_HSM_03785_DRIVER?? &&(HAVE_CRYPTO_HW_HSM_03785_DRIVER == true)) || (CRYPTO_WC_ECDSA?? &&(CRYPTO_WC_ECDSA == true))>
...
<#if (HAVE_CRYPTO_HW_CPKCC_44163_DRIVER?? &&(HAVE_CRYPTO_HW_CPKCC_44163_DRIVER == true)) || (CRYPTO_WC_ECDSA?? &&(CRYPTO_WC_ECDSA == true))>
